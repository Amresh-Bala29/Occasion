    ...
    conversations = [
        {
            ...
            "channel": "Email", "avatar_initials": "DW", "time_label": "Jul 11",
            "preview": "Final walkthrough before the Aug 6 summit",
            "unread": True, "archived": False,
            "quick_replies": [],
            "messages": [
                ("pier27-1", "You", True, "Fri, Jul 11", "9:42 AM", "Hi Dana,\n\nAhead of the NovaFlow Summit on Aug 6, we'd like a final walkthrough of the floor plan, load-in route, and AV setup at Pier 27. Would the morning of Aug 4 work on your end?\n\nIf it's easier, I can send our caterer's vehicle details in advance so security can pre-clear dock access.\n\nBest,\nAmresh"),
            ],
        },
        {
            "id": "thread-birite", "name": "Marco Reyes", "subtitle": "Catering coordinator · Bi-Rite Catering",
            "channel": "Email", "avatar_initials": "MR", "time_label": "Jul 11",
            "preview": "Catering quote request — 320 covers for Aug 6",
            "unread": True, "archived": False,
            "quick_replies": [],
            "messages": [
                ("birite-1", "You", True, "Fri, Jul 11", "10:05 AM", "Hi Marco,\n\nWe're finalizing catering for the NovaFlow Summit on Aug 6 at Pier 27 — 320 guests, including 40 vegan and 22 gluten-free. We're hoping for passed apps on arrival and a plated dinner at 7:00 PM, with setup from 3:30 PM.\n\nCould you put together a quote and let me know your cancellation terms?\n\nBest,\nAmresh"),
            ],
        },
        {
            "id": "thread-marina", "name": "Marina Sound", "subtitle": "Booking · Marina Sound",
            "channel": "Email", "avatar_initials": "MS", "time_label": "Jul 10",
            "preview": "After-party set — availability & hold for Aug 6",
            "unread": True, "archived": False,
            "quick_replies": [],
            "messages": [
                ("marina-1", "You", True, "Thu, Jul 10", "1:58 PM", "Hi Marina Sound team,\n\nWe'd love to book your 4-hour set for the NovaFlow Summit after-party on Aug 6 at Pier 27. We can provide a 20A circuit within 50 ft of the stage.\n\nCould you confirm availability and send a quote and deposit terms? I'll follow up with a must-play list once we're locked in.\n\nBest,\nAmresh"),
            ],
        },
        {
            "id": "thread-4imprint", "name": "4imprint Support", "subtitle": "Order #88214 · 4imprint",
            "channel": "Email", "avatar_initials": "4I", "time_label": "Jul 10",
            "preview": "Artwork approval & expedited run — 350 navy totes",
            "unread": True, "archived": False,
            "quick_replies": [],
            "messages": [
                ("4imprint-1", "You", True, "Thu, Jul 10", "10:15 AM", "Hi 4imprint team,\n\nWe'd like to move ahead on order #88214 — 350 navy totes with the attached artwork. We need them on-site by Aug 4, so please include expedited shipping.\n\nCan you confirm the production timeline and send the proof for final approval?\n\nBest,\nAmresh"),
            ],
        },
        {
            "id": "thread-eventstaff", "name": "Priya Shah", "subtitle": "Staffing lead · EventStaff Pro",
            "channel": "Email", "avatar_initials": "PS", "time_label": "Jul 9",
            "preview": "Crew request — 12 for Aug 6 (registration, setup, bar, AV)",
            "unread": True, "archived": False,
            "quick_replies": [],
            "messages": [
                ("eventstaff-1", "You", True, "Wed, Jul 9", "5:44 PM", "Hi Priya,\n\nFor the NovaFlow Summit on Aug 6 at Pier 27 we need 12 crew: 4 registration, 4 setup/cleanup, 2 bartenders, and 2 AV, with the first shift starting at 1:00 PM for setup.\n\nCould you confirm availability and rates? I'll send the full shift schedule once we're set.\n\nBest,\nAmresh"),
            ],
        },
        {
            "id": "thread-luma", "name": "Luma", "subtitle": "Listing review · Luma",
            "channel": "Email", "avatar_initials": "LU", "time_label": "Jul 9",
            "preview": "NovaFlow Summit listing — featured calendar & waitlist",
            "unread": True, "archived": False,
            "quick_replies": [],
            "messages": [
                ("luma-1", "You", True, "Wed, Jul 9", "11:03 AM", "Hi Luma team,\n\nOur NovaFlow Summit page is ready to go live — Aug 6 at Pier 27, capacity 320. Before we publish, could you confirm the event qualifies for your featured tech calendar and enable a waitlist once we hit capacity?\n\nHappy to share the preview link for review.\n\nBest,\nAmresh"),
            ],
        },
        {
            "id": "thread-foghorn", "name": "Foghorn DJs", "subtitle": "Backup quote · Foghorn DJs",
            "channel": "Email", "avatar_initials": "FD", "time_label": "Jul 8",
            "preview": "Backup hold for Aug 6 — courtesy through Jul 25?",
            "unread": True, "archived": False,
            "quick_replies": [],
            "messages": [
                ("foghorn-1", "You", True, "Tue, Jul 8", "2:20 PM", "Hi Foghorn DJs,\n\nThanks for the $2,800 quote for the NovaFlow Summit on Aug 6. We're still finalizing our headline set, and we'd love to keep you on standby as our backup.\n\nWould you be able to hold Aug 6 as a courtesy through Jul 25? I'll confirm either way by then.\n\nBest,\nAmresh"),
            ],
        },
        {
            "id": "thread-gallery308", "name": "Gallery 308", "subtitle": "Venue inquiry · Fort Mason Center",
            "channel": "Email", "avatar_initials": "G3", "time_label": "Jul 7",
            "preview": "Backup venue inquiry — Aug 6, ~320 guests",
            "unread": True, "archived": False,
            "quick_replies": [],
            "messages": [
                ("gallery308-1", "You", True, "Mon, Jul 7", "9:30 AM", "Hi Gallery 308 team,\n\nWe're planning the NovaFlow Summit for Aug 6 (~320 guests) and considering Fort Mason Center as a backup venue. Could you share availability, capacity, and pricing for that date?\n\nIf it's already spoken for, we'd appreciate being added to the waitlist.\n\nBest,\nAmresh"),
            ],
        },
    ]
    ...
    conversations = [
        {
            ...
            "preview": "Cake for the Aug 15 rooftop — 75 guests, summery",
            "unread": True, "archived": False,
            "quick_replies": [],
            "messages": [
                ("sugarbloom-1", "You", True, "Fri, Jul 10", "10:12 AM", "Hi Nadia,\n\nFor the rooftop 30th on Aug 15 we'd love a show-stopping cake for about 75 guests — something summery. We're open to your ideas on flavor and finish, and it'll need to hold in the heat with a delivery around 5 PM.\n\nCould you send a design and quote?\n\nBest,\nAmresh"),
            ],
        },
        {
            "id": "thread-rooftop25", "name": "Theo Marsh", "subtitle": "Events manager · Rooftop 25",
            "channel": "Email", "avatar_initials": "TM", "time_label": "Jul 9",
            "preview": "Rooftop 25 booking — Aug 15, load-in & sound",
            "unread": True, "archived": False,
            "quick_replies": [],
            "messages": [
                ("rooftop25-1", "You", True, "Wed, Jul 9", "2:20 PM", "Hi Theo,\n\nWe'd like to book Rooftop 25 for a private party on Aug 15, around 75 guests. Could you confirm the date, a 3 PM load-in via the freight elevator, and that amplified sound is OK until 11 PM?\n\nI'm also curious about the clear-tent canopy option in case the forecast turns.\n\nBest,\nAmresh"),
            ],
        },
        {
            ...
            "preview": "DJ set for the Aug 15 rooftop — availability & quote",
            "unread": True, "archived": False,
            "quick_replies": [],
            "messages": [
                ("skyline-dj-1", "You", True, "Tue, Jul 8", "1:40 PM", "Hi Skyline Sounds,\n\nWe're throwing a rooftop 30th on Aug 15 and would love to book your 4-hour set. We can provide a 20A circuit near the DJ table.\n\nCould you confirm availability and send a quote and deposit terms? A must-play list will follow once we're booked.\n\nBest,\nAmresh"),
            ],
        },
        {
            "id": "thread-copper-rye", "name": "Marisol Vega", "subtitle": "Bar lead · Copper & Rye Bar Co.",
            "channel": "Email", "avatar_initials": "MV", "time_label": "Jul 7",
            "preview": "Open-bar package for 75 — Aug 15 rooftop",
            "unread": True, "archived": False,
            "quick_replies": [],
            "messages": [
                ("copper-rye-1", "You", True, "Mon, Jul 7", "4:10 PM", "Hi Marisol,\n\nFor the rooftop party on Aug 15 (75 guests, roughly 5 hours) we're after an open-bar package — beer, wine, a couple of signature cocktails, and two bartenders.\n\nCould you send pricing, plus your setup/cleanup and cancellation terms?\n\nBest,\nAmresh"),
            ],
        },
        {
            "id": "thread-petal", "name": "Petal & Stem", "subtitle": "Florals · Petal & Stem",
            "channel": "Email", "avatar_initials": "PS", "time_label": "Jul 6",
            "preview": "Florals for Aug 15 — low centerpieces, warm tones",
            "unread": True, "archived": False,
            "quick_replies": [],
            "messages": [
                ("petal-1", "You", True, "Sun, Jul 6", "11:25 AM", "Hi Petal & Stem,\n\nWe'd love florals for the rooftop 30th on Aug 15 — around six low centerpieces in warm, late-summer tones with trailing greenery, plus a small install along the bar.\n\nCould you send a proposal and quote for install on Aug 14?\n\nBest,\nAmresh"),
            ],
        },
        {
            ...
            "preview": "Backup hold for Aug 15 — courtesy through Jul 20?",
            "unread": True, "archived": False,
            "quick_replies": [],
            "messages": [
                ("nightshift-1", "You", True, "Sun, Jun 29", "3:15 PM", "Hi Nightshift DJs,\n\nThanks for the $1,400 quote for Aug 15. We're finalizing our main DJ, but we'd love to keep you on standby as a backup.\n\nCould you hold Aug 15 as a courtesy through Jul 20? I'll confirm either way by then.\n\nBest,\nAmresh"),
            ],
        },
    ]
    for i, convo in enumerate(conversations):
    ...
    conversations = [
        {
            ...
            "preview": "Pizza for NovaHacks Aug 22–24 — staggered drops",
            "unread": True, "archived": False,
            "quick_replies": [],
            "messages": [
                ("tonys-1", "You", True, "Fri, Jul 11", "9:30 AM", "Hi Tony,\n\nWe're running NovaHacks Aug 22–24 for ~200 hackers and will need a lot of pizza across the weekend — Fri dinner, Sat lunch and dinner, Sun lunch — with roughly 30 vegan and 18 gluten-free.\n\nCan you handle staggered drops with warmers, and send a quote and cancellation terms?\n\nBest,\nAmresh"),
            ],
        },
        {
            "id": "thread-gigastage", "name": "Renée Park", "subtitle": "Solutions lead · GigaStage AV",
            "channel": "Email", "avatar_initials": "RP", "time_label": "Jul 10",
            "preview": "Networking + stage AV for 200 devices — Aug 22–24",
            "unread": True, "archived": False,
            "quick_replies": [],
            "messages": [
                ("gigastage-1", "You", True, "Thu, Jul 10", "2:05 PM", "Hi Renée,\n\nFor NovaHacks (Aug 22–24, ~200 devices) we need solid Wi-Fi plus stage AV for the kickoff and demos — we're thinking multiple access points and a dedicated line, with install and load-testing on Aug 21.\n\nCould you scope this and send a quote and deposit terms?\n\nBest,\nAmresh"),
            ],
        },
        {
            "id": "thread-prizes", "name": "Jordan Blake", "subtitle": "Sponsorship · NovaFlow",
            "channel": "Email", "avatar_initials": "JB", "time_label": "Jul 9",
            "preview": "NovaHacks prize pool — $12k for sign-off",
            "unread": True, "archived": False,
            "quick_replies": [],
            "messages": [
                ("prizes-1", "You", True, "Wed, Jul 9", "4:40 PM", "Hi Jordan,\n\nWe'd like to lock the NovaHacks prize pool: $12,000 total — $10k cash across three tracks plus six flagship laptops for the category winners.\n\nCan you confirm the budget so we can line up the cash wire and the hardware order in time?\n\nBest,\nAmresh"),
            ],
        },
        {
            "id": "thread-printhaus", "name": "PrintHaus Support", "subtitle": "Order #40912 · PrintHaus",
            "channel": "Email", "avatar_initials": "PH", "time_label": "Jul 8",
            "preview": "Swag order #40912 — proof approval & timeline",
            "unread": True, "archived": False,
            "quick_replies": [],
            "messages": [
                ("printhaus-1", "You", True, "Tue, Jul 8", "10:22 AM", "Hi PrintHaus team,\n\nWe'd like to move ahead on order #40912 — 220 shirts, plus stickers and lanyards — using the attached artwork. We need everything on-site by Aug 20.\n\nCould you confirm the production run fits that timeline and send the proof for final approval?\n\nBest,\nAmresh"),
            ],
        },
        {
            "id": "thread-shield", "name": "Priya Nair", "subtitle": "Ops · Shield Security",
            "channel": "Email", "avatar_initials": "PN", "time_label": "Jul 7",
            "preview": "Overnight security for NovaHacks — Fri–Sun",
            "unread": True, "archived": False,
            "quick_replies": [],
            "messages": [
                ("shield-1", "You", True, "Mon, Jul 7", "6:10 PM", "Hi Priya,\n\nNovaHacks runs overnight Aug 22–24 and we need security coverage Fri through Sun — ideally two guards on rotation plus badge checks at the door for the lock-in.\n\nCould you confirm availability and rates? I'll share the floor plan so we can set patrol points.\n\nBest,\nAmresh"),
            ],
        },
        {
            "id": "thread-metroav", "name": "MetroAV", "subtitle": "Backup quote · MetroAV",
            "channel": "Email", "avatar_initials": "MA", "time_label": "Jun 28",
            "preview": "Backup AV hold — courtesy through Jul 18?",
            "unread": True, "archived": False,
            "quick_replies": [],
            "messages": [
                ("metroav-1", "You", True, "Sun, Jun 28", "1:05 PM", "Hi MetroAV,\n\nThanks for the $6,900 quote for AV and networking at NovaHacks. We're finalizing our primary vendor, but we'd love to keep you on standby as our backup.\n\nCould you hold our dates as a courtesy through Jul 18? I'll confirm either way by then.\n\nBest,\nAmresh"),
            ],
        },
    ]
    for i, convo in enumerate(conversations):
